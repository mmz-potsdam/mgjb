...
class ImportJewishCemeteriesBrandenburgCommand extends Command
{
    protected $FIELD_MAP = [
        'id' => 'identifier',
        'surname' => 'familyName',
        'forename' => 'givenName',
        'gender' => 'gender',
        'birth_place' => 'birthPlaceLabel',
        'birth_date' => 'birthDate',
        'death_place' => 'deathPlaceLabel',
        'death_date' => 'deathDate',
        'profession' => 'hasOccupation',
    ];

    protected $DATAPROVIDER = 5; // TODO: come up with a table
    ...
    {
        $this
            ->setName('import:jewish-cemeteries-brandenburg')
            ->setDescription('Import Juedische Friedhoefe Brandenburg')
        ;
    }
    ...
    {
        $fname = $this->dataDir
               . '/jewish_cemeteries_brandenburg_persons_selection.xlsx';
        ...
        foreach ($reader->getSheetIterator() as $sheet) {
            foreach ($sheet->getRowIterator() as $rowObj) {
                ...
                $person->disambiguatingDescription = 'Grabstein ' . $name;
